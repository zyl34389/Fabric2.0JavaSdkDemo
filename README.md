...
5. chaincode目录中是链码安装和调用的方法
6. channel目录中是通道安装和加入节点的方法
7. 注释还行吧，应该自己能看懂，记得安装go、java和Fabric环境。
8. script中是自动化配置Fabric环境的脚本
9. Fabric配置.txt中是命令行配置环境的命令
10. QQ 406244471 欢迎交流学习，指教，我也不会，嘻嘻嘻！
## 功能
